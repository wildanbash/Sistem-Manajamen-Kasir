				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav" class="p-t-30">
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
							...
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item" ><a href="<?=site_url('sales/item_data')?>" onclick="generate.set()" class="sidebar-link"><i
								...
								<!-- <li class="sidebar-item"><a href="<?=site_url('stock/in/del')?>" class="sidebar-link"><i
											class="mdi mdi-checkbox-blank-circle-outline"></i><span
	...
	<script>
		...
		function generate_invoice(){
			...
			return{
				...
				set : function(){
					invoice_generate = invoice_generate=(Math.random().toString(36).substr(2,9)).toUpperCase();
				}
			}
		}

		var generate = new generate_invoice();
